...
/**
 * Class designed for testing the Chatbot object with JUnit. We will be developing tests for this as a class. Each additional test will be a version decimal update.
 * 
 * @author CodyH
 * @version 1.0
 */
